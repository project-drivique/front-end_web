...
export default function ReservationFlowPage() {
  ...
  // ─── Pantalla: Éxito / Pago ───────────────────────────────────────────────
  if (exito) return (
    <div className="catalogo-page" style={{ minHeight: '100vh', background: 'var(--hero-fondo)', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ position: 'absolute', top: -80, right: -80, width: 500, height: 500, borderRadius: '50%', background: 'var(--hero-orb1)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: -60, left: -60, width: 350, height: 350, borderRadius: '50%', background: 'var(--hero-orb2)', pointerEvents: 'none' }} />

      <div style={{ position: 'relative', textAlign: 'center', maxWidth: 560, width: '100%', background: 'var(--bg-tarjeta)', borderRadius: 28, boxShadow: '0 24px 70px rgba(15,23,42,0.16)', border: '1px solid var(--borde)', padding: '48px 40px' }}>
        <img src={logo} alt="Drivique" style={{ width: 116, height: 116, borderRadius: '50%', objectFit: 'contain', background: '#fff', padding: 16, margin: '0 auto 28px', boxShadow: '0 14px 34px rgba(30,58,138,0.24)', border: '1px solid var(--borde)' }} />
