...
export const COMBUSTIBLES = ['Todos', 'Gasolina', 'Diesel', 'Híbrido', 'Eléctrico']

export const CIUDADES = ciudadesData
export const SUCURSALES = sucursalesData

export const RECARGOS_LOGISTICOS = {
  domicilio: 50000,
  aeropuerto: 40000,
  terminal: 25000
}